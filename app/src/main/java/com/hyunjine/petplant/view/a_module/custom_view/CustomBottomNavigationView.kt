...
class CustomBottomNavigationView : ConstraintLayout {
    private var mPath: Path = Path()
    private var mPaint: Paint = Paint()

    private val CURVE_CIRCLE_RADIUS : Int get() = (width * 0.0833).toInt()
    ...
    private fun init() {
        ...
        mPaint.color = ContextCompat.getColor(context, R.color.main_green)
